...
public class KaratsubaMultiplication {
    ...
    private static void parent(Polynomial p1, Polynomial p2, int nr) {
        ...
        System.out.println("Karatsuba multiplication of polynomials:\n" + result.toString());
    ...
    private static void child() {
        ...
        Polynomial pp = (Polynomial) p1[0];
        Polynomial qq = (Polynomial) p2[0];
        ...
        Polynomial result = Operation.karatsuba(pp, qq);
