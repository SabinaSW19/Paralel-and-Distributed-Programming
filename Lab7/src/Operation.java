...
public class Operation {
    ...
    public static Polynomial multiply(Object o, Object o1, int begin, int end) {
    ...
    public static Polynomial result(Object[] results) {
    ...
    public static Polynomial karatsuba(Polynomial p1, Polynomial p2) {
        ...
        Polynomial z1 = karatsuba(lowP1, lowP2);
        Polynomial z2 = karatsuba(Polynomial.add(lowP1, highP1), Polynomial.add(lowP2, highP2));
        Polynomial z3 = karatsuba(highP1, highP2);
